---
name: speckit-parallel-implement-run
description: Thin tech-lead parallel implementation — parse tasks.md, orchestrate
  worktrees and delegated subagents (phase/story/merge/validate) so merge and validation
  never pollute orchestrator context.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: parallel-implement:commands/parallel-implement.md
---
...
Run `.specify/scripts/bash/check-prerequisites.sh --json --require-tasks --include-tasks` from repo root and parse FEATURE_DIR and AVAILABLE_DOCS. Record:
