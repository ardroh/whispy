---
name: speckit-parallel-implement-story
description: 'Internal delegate: implement exactly one tasks.md user story in a dedicated
  git worktree'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: parallel-implement:commands/parallel-implement-story.md
---
